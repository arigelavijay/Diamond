    ...
    public class OrderIssueDetailDAL
    {
        ...
        public bool Save<T>(T item) where T : IContract
        {
            ...
            try
            {
                ...
                db.AddInParameter(savecommand, "ReferenceNo", System.Data.DbType.String, orderissuedetail.ReferenceNo);
        ...
        {
            var orderdetailItem = new OrderIssueDetail { OrderNo = orderNo };
