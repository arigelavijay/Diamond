 /*
=======================================================================
 START		[Report].[usp_InvoiceCashBill]
=======================================================================
Author:		Sudarshan
Create date:	2015-05-21
Description:	Select All Columns From [Operation].[InvoiceHeader] Table

Exec [Report].[usp_InvoiceCashBill] 'INV151100005'

=======================================================================
*/

IF OBJECT_ID('[Report].[usp_InvoiceCashBill]') IS NOT NULL
BEGIN 
    DROP PROC [Report].[usp_InvoiceCashBill]
END 
GO
CREATE  PROC [Report].[usp_InvoiceCashBill]
